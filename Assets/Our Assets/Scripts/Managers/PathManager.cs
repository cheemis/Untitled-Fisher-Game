...
{
    public List<GameObject> InnerpathNodes = new List<GameObject>();
    public List<GameObject> OuterpathNodes = new List<GameObject>();
    // Start is called before the first frame update
    void Start()
    {
        //for (int i = 0; i < InnerpathNodes.Count; i++)
        //{
        //    PathNode node = InnerpathNodes[i].GetComponent<PathNode>();
        //    // set the first node's previous Node as the last node in the list
        //    if (i == 0)
        //    {            
        //        node.previousNode = InnerpathNodes[pathNodes.Count - 1].GetComponent<PathNode>();
        //    }
        //    else
        //    {               
